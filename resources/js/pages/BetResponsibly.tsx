...
<p class="mb-4 text-gray-700 font-bold">Plagio</p>
<p class="mb-4 text-gray-700">
...
<p class="mb-4 text-gray-700 font-bold">Transparencia en los resultados</p>
<p class="mb-4 text-gray-700">
...
<p class="mb-4 text-gray-700 font-bold">Prohibida la manipulación de estadísticas</p>
<p class="mb-4 text-gray-700">
...
<p class="mb-4 text-gray-700 font-bold">Indicar la casa de apuestas y la cuota exacta</p>
<p class="mb-4 text-gray-700">
...
<p class="mb-4 text-gray-700 font-bold">Reenvío de picks y piratería</p>
<p class="mb-4 text-gray-700">
