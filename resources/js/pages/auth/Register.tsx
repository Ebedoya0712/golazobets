...
import { RegisterProfileTypeSelector } from './components'
...
const Page = ({ layout, sports }: Props) => {
	const [profileTypeSelected, setProfileTypeSelected] = useState(false)
	...
	return (
		<>
			<div className="w-96 space-y-7">
				<RegisterProfileTypeSelector
					type={data.user_type}
					selected={(selection) => {
						setData('user_type', selection)
